...
namespace Lab10a
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            result_2a = numbers.Where(x => x >= 0);
            result_2a = result_2a.Transform(x => (int)Math.Pow(x, 2));
            ...
            result_2b = students.Where(x => x.GradeAverage >= 4.2 && x.Age > 20).Transform(x => x.Name);
            ...
            result_3b = students.FindFirstIfOrDefault(x => x.Age < 18);
            ...
            double count = students.Where(x => x.GradeAverage < 4.4).ToArray().Length;
            result_3c = students.Where(x => x.GradeAverage < 4.4).Accumulate(result_3c, (x, y) => x + y.Age) / count;
            ...
            result_4a = sorted_numbers.Unique((x, y) => Math.Abs(x + y) % 2 == 1);
            ...
            var function = EnumerableExtender.MinFunc<int>(x => x, x => 4, x => x * x - 5 * x, x => -Math.Abs(x));
            result_4b = sorted_numbers.Transform(function);
